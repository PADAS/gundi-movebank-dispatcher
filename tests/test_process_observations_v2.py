...
async def test_process_batch_v2_is_retried_on_movebank_error(
    ...
    assert mock_movebank_client_class_with_error_once.return_value.post_tag_data.call_count == 2
...
async def test_process_batch_v2_is_retried_on_portal_error(
    ...
    assert mock_gundi_client_v2_class_with_error_once.return_value.get_integration_details.call_count == 2
